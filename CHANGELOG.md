...
- Keep Bootstrap upgrades from downgrading older projects to historical Prodockit floors.
- Add theme-aware stag icons and correct the Examples capability table rendering.
